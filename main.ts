namespace SpriteKind {
    ...
    export const HANDS = SpriteKind.create()
    export const firsajvwesalc = SpriteKind.create()
    export const DarkSkeleton = SpriteKind.create()
}
sprites.onOverlap(SpriteKind.DarkSkeleton, SpriteKind.Player, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
    pause(2000)
})
...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    pause(1000)
    mySprite2.setVelocity(-5, -50)
    pause(600)
    mySprite2.setVelocity(0, 0)
    mySprite2.sayText("*click*")
    pause(200)
    mySprite2.setFlag(SpriteFlag.Invisible, true)
    pause(1000)
    scene.setBackgroundImage(img`
        ...
        eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
        `)
    door2 = sprites.create(assets.image`myImage5`, SpriteKind.door)
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    if (info.score() == -1) {
        ...
        Ugly = sprites.create(img`
            ...
            . . . . . f f . . f f . . . . . 
            `, SpriteKind.Player)
        controller.moveSprite(Ugly)
        Ugly.setPosition(11, 91)
        pause(100)
        Skeleton22 = sprites.create(assets.image`skellyWalkFront2`, SpriteKind.DarkSkeleton)
        sprites.destroy(Animation)
        Skeleton22.follow(mySprite3, 30)
        Skeleton22.setScale(0.5, ScaleAnchor.Middle)
        Sprite6 = sprites.create(assets.image`myImage14`, SpriteKind.Food)
        Sprite6.setPosition(80, 35)
        info.changeScoreBy(1)
    }
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Skeleboss2, function (sprite, otherSprite) {
    ...
    Skeleton5.follow(mySprite3, 30)
    Skeleton22.follow(mySprite3, 30)
    Skeleton32.setPosition(67, 115)
    Skeleton32.follow(mySprite3, 30)
    Skeleton5.setPosition(67, 108)
    Skeleton22.setPosition(67, 120)
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Skelebosss5, function (sprite, otherSprite) {
    sprites.destroy(Status_Bar)
    sprites.destroy(Skelebosss)
    sprites.destroy(mySprite3)
    Animation = sprites.create(img`
        . . . . . . f f f f . . . . . . 
        . . . . f f f 2 2 f f f . . . . 
        . . . f f f 2 2 2 2 f f f . . . 
        . . f f f e e e e e e f f f . . 
    ...
    Animation.setPosition(mySprite3.x, mySprite3.y)
    Animation.sayText("whew", 500, false)
    pause(200)
    Animation.setVelocity(50, 0)
    pause(2000)
    ...
    scene.setBackgroundImage(img`
        ...
        .......................222222222222222..............................................................................................2222222222222222222222......
        .......................222222222222222..............................................................................................2222222222222222222222......
        .......................22222222222222.....22222....................................................................................22222222222222222222222......
        .......................22222222222222.....22222..................................22222.............................................22222222222222222222222......
        ........................222222222222......22222..................................22222.............................................22222222222222222222222......
        ........................22222222222.......22222.............22222................22222.......................22222.................22222222222222222222222......
        .........................2222222222.......22222.............22222................22222.......................22222.................22222222222222222222222......
        ............................................................22222................22222.......................22222.................22222222222222222222222......
        ............................................................22222............................................22222.................22222222222222222222222......
        ............................................................22222............................................22222.................22222222222222222222222......
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.door, function (sprite, otherSprite) {
    ...
    Skeleton22.follow(mySprite3, 20)
    Skeleton32.follow(mySprite3, 60)
    Skeleton42.follow(mySprite3, 20)
    Skeleton22.setPosition(137, 70)
    Skeleton32.setPosition(138, 78)
    Skeleton42.setPosition(131, 98)
    BIGDOOR2 = sprites.create(assets.image`myImage5`, SpriteKind.BIGDOOR)
    BIGDOOR2.setPosition(140, 92)
})
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.BIGDOOR, function (sprite, otherSprite) {
    ...
    Skeleton5 = sprites.create(img`
        ...
        . . . . . . . f f f . . . . . . 
        `, SpriteKind.Skeleton)
    Skeleton5.follow(mySprite3)
    Skeleton5.setPosition(6, 81)
})
info.onLifeZero(function () {
    scene.setBackgroundImage(img`
        ...
        
        ...
        
    ...
    Skeleton5.setFlag(SpriteFlag.Invisible, true)
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Skeleboss4, function (sprite, otherSprite) {
    ...
    Skelebosss = sprites.create(img`
        ...
        . . . c 6 7 7 7 7 6 c . . . . . 
        . . c 7 7 2 7 7 7 7 2 c . . . . 
        . c 6 7 7 7 7 2 7 7 7 6 c . . . 
        . c 7 c 6 6 6 6 c 7 7 7 c . . . 
        . f 7 6 f 6 6 f 6 7 2 7 f . . . 
        . f 2 7 2 7 7 7 7 7 7 7 f . . . 
        . . f 7 7 7 7 6 c 7 7 6 f c . . 
        . . . f c c c 2 7 7 6 f 7 7 c . 
        . . c 7 2 7 7 7 6 c f 7 2 7 7 c 
        . c 7 7 2 7 7 c f c 6 7 7 6 c c 
        c 1 1 1 2 7 6 f c c 2 6 6 c . . 
        f 1 1 1 1 1 6 6 c 6 6 6 6 f . . 
        f 6 1 1 2 1 1 6 6 6 6 6 c f . . 
        . f 6 1 1 1 2 1 1 6 6 6 f . . . 
        . . c c c c c c c c c f . . . . 
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Skeleboss, function (sprite, otherSprite) {
    ...
    Skeleton5.follow(mySprite3, 30)
    Skeleton22.follow(mySprite3, 30)
    Skeleton5.setPosition(39, 43)
    Skeleton22.setPosition(39, 53)
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.skeleboss3, function (sprite, otherSprite) {
    ...
    Skeleton22.follow(mySprite3, 30)
    Skeleton32.follow(mySprite3, 30)
    Skeleton42.follow(mySprite3, 30)
    Skeleton5.setPosition(70, 62)
    Skeleton22.setPosition(67, 52)
    Skeleton32.setPosition(58, 52)
    Skeleton42.setPosition(58, 69)
})
let BIGDOOR2: Sprite = null
let Skeleton42: Sprite = null
let Skeleton32: Sprite = null
let Skelebosss: Sprite = null
let Status_Bar: Sprite = null
let projectile: Sprite = null
let Animation: Sprite = null
let Skeleton22: Sprite = null
let Ugly: Sprite = null
let Skeleton5: Sprite = null
...
let TitleScreen = sprites.create(img`
    ...
    
...
music.play(music.createSong(assets.song`note2`), music.PlaybackMode.UntilDone)
timer.after(2000, function () {
    Note2 = "You Can Add Music Here!"
    pauseUntil(() => info.score() == 0)
